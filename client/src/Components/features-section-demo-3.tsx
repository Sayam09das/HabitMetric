...
const COLORS = {
  ...
  background: "#F9FAFB", // Neutral warm white
  ...
  return (
    ...
    >
      <div className="px-8">
        ...
        <p
          className="text-sm lg:text-base max-w-2xl my-4 mx-auto text-center font-normal"
...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn("p-4 sm:p-8 relative overflow-hidden rounded-3xl shadow-md", className)}
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p
      className="max-w-5xl mx-auto text-left tracking-tight text-xl md:text-2xl md:leading-snug"
      style={{ color: COLORS.textMain }}
    >
      {children}
    </p>
...
const FeatureDescription = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p
      className="text-sm md:text-base max-w-4xl text-left mx-auto my-2"
      style={{ color: COLORS.textLight }}
    >
      {children}
    </p>
...
export const SkeletonOne = () => {
  return (
    <div className="relative flex py-8 px-2 gap-10 h-full">
      <div
        className="w-full p-5 mx-auto shadow-2xl group h-full"
...
export const SkeletonTwo = () => {
  const images = [
    "https://images.unsplash.com/photo-1517322048670-4fba75cbbb62?q=80&w=3000",
    "https://images.unsplash.com/photo-1573790387438-4da905039392?q=80&w=3425",
    "https://images.unsplash.com/photo-1555400038-63f5ba517a47?q=80&w=3540",
    "https://images.unsplash.com/photo-1554931670-4ebfabf6e7a9?q=80&w=3387",
    "https://images.unsplash.com/photo-1546484475-7f7bd55792da?q=80&w=2581",
  ];
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 shadow border border-gray-200 shrink-0 overflow-hidden"
            style={{ backgroundColor: COLORS.cardBg }}
          >
            <img
              src={image}
